...
import { Student, StudentTracker } from './kata';
...
describe('Student Class', () => {
    ...
    it('should calculate the average grade correctly when no grades', () => {
        const mikey = new Student('Mikey', []);
        expect(mikey.averageGrade).toBeCloseTo(0, 2);
    });
